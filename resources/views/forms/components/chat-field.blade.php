@php
    $ownerRecord = $getResolvedOwnerRecord();
    $styleHref = \Filament\Support\Facades\FilamentAsset::getStyleHref('chat-field-styles', package: 'bergstar/chat-field');
@endphp

<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div x-load-css="[@js($styleHref)]">
